...
- [x] Exercise the actual packaged apphost with six private parent-proc assets; prove a correlated sanitized package rejection, malformed-proc rejection followed by a healthy retry in the same session, confirmed child reap, closed descriptors, exact workspace cleanup, and 20/20 repeated runs without network or private fixtures ([PR verification record](https://github.com/4eh5xitv6787h645ebv/SMAPI/pull/198)).
