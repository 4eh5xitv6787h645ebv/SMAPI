...
- [x] Bind accepted statements to the exact repository and owner IDs, tag/ref/source commit and workflow, GitHub-hosted push and public-source identity, SLSA predicate/build/run/transparency evidence, and retained subject digest and size; expose only curated trust evidence ([strict policy implementation](https://github.com/4eh5xitv6787h645ebv/SMAPI/pull/184)).
