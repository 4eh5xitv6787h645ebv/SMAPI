...
- [x] Use the same pinned acquisition/staging policy for release qualification, tagged verification, standard develop builds, and documented Linux/WSL manual builds; inventory every repository `--linux-only` caller ([merged implementation](https://github.com/4eh5xitv6787h645ebv/SMAPI/pull/186)).
