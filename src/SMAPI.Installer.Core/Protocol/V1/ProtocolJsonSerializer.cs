...
public static class ProtocolJsonSerializer
{
    ...
    private static void ValidatePrePlanRejection(PrePlanRejectedEvent value)
    {
        ...
        (ProtocolNextAction ExpectedAction, bool ExpectedTerminal) expected = value.ErrorCode switch
        {
            ...
            ProtocolPrePlanErrorCode.PackageIntegrityRejected => (ProtocolNextAction.ReopenVerifiedPackage, false),
            ProtocolPrePlanErrorCode.PackageMetadataRejected => (ProtocolNextAction.ReopenVerifiedPackage, false),
            ProtocolPrePlanErrorCode.PackageArchiveRejected => (ProtocolNextAction.ReopenVerifiedPackage, false),
            ProtocolPrePlanErrorCode.PackageProvenanceRejected => (ProtocolNextAction.ReopenVerifiedPackage, false),
            ProtocolPrePlanErrorCode.PackageReleaseIdentityRejected => (ProtocolNextAction.ReopenVerifiedPackage, false),
