...
internal static class ModHealthReportFixtureFactory
{
    public static ModHealthReport CreateCanonical()
    {
        ...
        return new(
            ...
            Environment: new("4.5.2-fork", "abc1234", "1.6.15", ".NET 6.0.36", "x64", "Linux", "6.12", "wayland", "en-AU", 8, "single-player", 1),
            ...
            Performance: new(
                ...
                SlowUpdateCount: 3,
                Callbacks: ImmutableArray.Create(new ModHealthCallback("Example.Mod", "Example Mod", ModHealthExecutionPhase.Update, ModHealthOperationKind.Event, "Example.Mod.OnUpdate", null, 3600, 12, 0.08, 0)),
            ...
            Mods: ImmutableArray.Create(new ModHealthMod("Example.Mod", "Example Mod", "1.2.3", ModHealthModKind.CodeMod, null, ModHealthModStatus.Loaded, null, ImmutableArray<string>.Empty, null, 0, 0, 0, 0, 3, 120)),
            Logs: ImmutableArray.Create(new ModHealthLogSummary("Example.Mod", 3, 0, 0, 0, 0, 120, 100, 59000)),
