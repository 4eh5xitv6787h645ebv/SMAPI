    ...
    public static ModHealthReport CreateCanonical()
    {
        ...
        return new(
            ...
            Performance: new(
                ...
                WorstUpdates: ImmutableArray.Create(new ModHealthUpdate(1200, 20000, 41.2, 38, 0.2, 0, 3, true, "gameplay", true, 0, 0, 0, 0, 2, 0, 0, true, ImmutableArray.Create(new ModHealthContributor("Example.Mod", 0.2)), 1)),
